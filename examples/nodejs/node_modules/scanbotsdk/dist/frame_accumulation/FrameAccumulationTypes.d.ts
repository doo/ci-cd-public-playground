...
"INTERPOLATE";
/** @hidden */
export declare const ConfirmationMethodValues: ReadonlyArray<ConfirmationMethod>;
/**
Configuration for how to accumulate results.
*/
export declare class ResultAccumulationConfiguration {
    /**
    Method used to confirm a result.
...
*/
export declare class AccumulatedResultsVerifierConfiguration {
    /**
