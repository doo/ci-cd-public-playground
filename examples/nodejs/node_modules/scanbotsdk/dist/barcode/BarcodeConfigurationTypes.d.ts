...
import { Gs1Handling } from "../barcode/BarcodeTypes";
import { UpcEanExtensionBehavior } from "../barcode/BarcodeTypes";
/**
...
export declare namespace BarcodeFormatConfigurationBase {
    /** @internal */
    function from(source: DeepPartial<BarcodeFormatConfigurationBase>): BarcodeFormatConfigurationBase;
}
/**
...
export declare namespace BarcodeFormatOneDConfigurationBase {
    /** @internal */
    function from(source: DeepPartial<BarcodeFormatOneDConfigurationBase>): BarcodeFormatOneDConfigurationBase;
}
/**
...
export declare namespace BarcodeFormatTwoDConfigurationBase {
    /** @internal */
    function from(source: DeepPartial<BarcodeFormatTwoDConfigurationBase>): BarcodeFormatTwoDConfigurationBase;
}
/**
...
export declare namespace BarcodeFormatFourStateConfigurationBase {
    /** @internal */
    function from(source: DeepPartial<BarcodeFormatFourStateConfigurationBase>): BarcodeFormatFourStateConfigurationBase;
}
/**
